...
var WEEKDAYS_SHORT = ["Pt", "Sa", "Ça", "Pe", "Cu", "Ct", "Pz"];
var MONTHS = [
  "January",
  "February",
  "March",
...
var Datepicker = /** @class */ (function () {
  ...
  Datepicker.prototype.load = function (mode) {
    ...
    head.append(prev);
    prev.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="white" width="16" height="16" viewBox="0 0 24 24"><path d="M16.67 0l2.83 2.829-9.339 9.175 9.339 9.167-2.83 2.829-12.17-11.996z"/></svg>`;
    // Center
    ...
    head.append(next);
    next.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" fill="white" width="16" height="16" viewBox="0 0 24 24"><path d="M5 3l3.057-3 11.943 12-11.943 12-3.057-3 9-9z"/></svg>
`;
    // Table
